...
WSGI_APPLICATION = 'vamis.wsgi.application'
...
# MySQL connector (uncomment to switch, comment out SQLite above)
# DATABASES = {
#     'default': {
#         'ENGINE': os.getenv('DB_ENGINE', 'django.db.backends.mysql'),
#         'NAME': os.getenv('DB_NAME', 'vamis_db'),
...
SESSION_INACTIVITY_TIMEOUT = 1890  # 15 min
